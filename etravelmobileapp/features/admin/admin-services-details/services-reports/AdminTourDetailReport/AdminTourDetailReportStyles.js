...
export default StyleSheet.create({
    ...
    price: { fontSize: 20, fontWeight: 'bold', color: PRIMARY_COLOR, marginBottom: 15 },
    highlightBox: { backgroundColor: '#F1F5F9', padding: 15, borderRadius: 12, marginBottom: 15 },
    infoRow: { flexDirection: 'row', alignItems: 'center', marginVertical: 6 },
    infoText: { fontSize: 15, color: '#334155', marginLeft: 8 },
